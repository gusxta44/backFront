export default function RoomCards(itemCard, index = 0) {
    const {
        nome,
        numero,
        qnt_cama_casal,
            ...
            <div id="carouselExampleIndicators-${index}" class="carousel slide">
                ...
                <div class="carousel-inner shadow">
                    <div class="carousel-item active">
                        <img src="public/assets/images/img.jpg" class="d-block w-100" alt="Imagem 1">
                    </div>
                    ...
                    <div class="carousel-item">
                        <img src="public/assets/images/imgpremium.jpg" class="d-block w-100" alt="Imagem 3">
                    </div>
                </div>
            </div>
